...
[**configuration_retrieve**](ApplicationApi.md#configuration_retrieve) | **GET** /application/configuration | 
...
> ApplicationConfiguration configuration_retrieve()



Return configuration metadata for application app
...
with osis_attribution_sdk.ApiClient(configuration) as api_client:
    ...
    # and optional values
    try:
        api_response = api_instance.configuration_retrieve(accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
        pprint(api_response)
    except osis_attribution_sdk.ApiException as e:
        print("Exception when calling ApplicationApi->configuration_retrieve: %s\n" % e)
```
